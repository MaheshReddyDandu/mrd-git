"""add_client_and_project_tables

Revision ID: c49a4e208180
Revises: 83596818d9d4
Create Date: 2025-06-21 18:47:44.856493
...
revision: str = 'c49a4e208180'
down_revision: Union[str, None] = '83596818d9d4'
...
def downgrade() -> None:
    ...
    sa.UniqueConstraint('name', 'tenant_id', name='ix_roles_name_tenant'),
    postgresql_ignore_search_path=False
    )
